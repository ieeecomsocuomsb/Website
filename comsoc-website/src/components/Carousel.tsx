    ...
    <div className="carousel flex flex-col">
      <div className="flex gap-8 w-[90%]">
        <div className="carousel-content w-[40%] p-6">
          ...
          <br />
          <p>
            With the transition of responsibilities, the chapter begins a new
            term dedicated to strengthening communication-related learning and
            collaboration. The AGM marked both appreciation for past service and
            renewed enthusiasm toward advancing the chapter’s role in the
            evolving field of communication technology.
          </p>
        </div>
      ...
      <div className="flex gap-8 w-[90%]">
        <div className="carousel-content w-[40%] p-6">
          ...
          <p>
            ...
            As the second iteration of this communication-focused ideathon,
            Comfix’25 brought together enthusiastic young innovators who share a
            passion for advancing the field. Their contributions highlight the
            growing importance of communication-driven solutions in addressing
            the needs of an interconnected society.
          </p>
        </div>
      </div>
      ...
      <div className="flex gap-8 w-[90%]">
        <div className="carousel-content w-[40%] p-6">
          ...
          <hr />
          <p>
            Modern communication relies heavily on resilient digital infrastructure, and datacenters stand at the core of this global connectivity. To help undergraduates gain exposure to these essential systems, the IEEE Communications Society Student Branch Chapter of the University of Moratuwa organized a field visit to a national-level datacenter, offering a first-hand look at how uptime, reliability, and secure data flow are maintained.</p><br/><p>

The visit allowed students to observe the critical engineering behind communication networks that support daily digital interactions. This experience strengthened their understanding of how robust communication architectures sustain the increasingly interconnected world around us.
          </p>
        </div>
      </div>
